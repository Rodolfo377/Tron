...
struct Matrix44
{
	...
	//Imports values from glm::mat4 to Matrix44
	Matrix44(glm::mat4 a_mat);
	glm::mat4 convertToglmMatrix(Matrix44);

	//Imports values from Vector3 to glm::tvec3
	static glm::vec3 importFrom(Vector3 v3);

	//print matrix
	void printMatrix(Matrix44 myMatrix);
	...
	float Determinant( Matrix44 &identity_44, bool inverse = false) const;
	...
	//ROTATION MATRICES DESCRIBED IN NOTES
	/// Angle in radians
